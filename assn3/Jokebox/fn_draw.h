...
//Level B
void _draw_rect(float x, float y, float width, float height, COLOR color, float stroke, float cx, float cy, float rotation);
void _draw_triangle(float x, float y, float width, float height, float aoff, TRIANGLEDIR dir, COLOR color, float stroke, float cx, float cy, float rotation);
...
void _draw_texture(TEXTURE texture, float x, float y, float width, float height,
	float opacity, float sourceX, float sourceY, float sourceWidth, float sourceHeight, float cx, float cy, float rotation);
